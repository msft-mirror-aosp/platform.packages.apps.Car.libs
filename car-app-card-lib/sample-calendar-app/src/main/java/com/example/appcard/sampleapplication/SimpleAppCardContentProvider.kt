...
class SimpleAppCardContentProvider : AppCardContentProvider() {
    ...
    override fun onCreate(): Boolean {
        ...
        context?.let {
            calendarAndClockAppCardProvider =
                CalendarAppCardProvider(it.applicationContext, CALENDAR_CLOCK_ID, appCardUpdater)

            calendarAppCardProvider =
                CalendarAppCardProvider(
