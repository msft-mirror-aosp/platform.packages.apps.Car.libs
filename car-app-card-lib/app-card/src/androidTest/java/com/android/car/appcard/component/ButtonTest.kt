...
class ButtonTest {
    ...
    fun testGetButtonType_secondary() {
        val button =
            newBuilder(TEST_COMPONENT_ID, Button.ButtonType.SECONDARY, onClickListener)
                .setText(TEST_TEXT)
                .build()
    ...
    fun testUpdateComponent_buttonComponent_notEqualComponentId_returnFalse() {
        val button =
            newBuilder(TEST_COMPONENT_ID, Button.ButtonType.PRIMARY, onClickListener)
                ...
                .build()
        val input =
            newBuilder(TEST_TEXT, Button.ButtonType.PRIMARY, onClickListener)
                .setText(TEST_TEXT)
                .build()
    ...
    fun testUpdateComponent_imageComponent_imageTooLarge_returnFalse() {
        val button =
            newBuilder(TEST_COMPONENT_ID, Button.ButtonType.PRIMARY, onClickListener)
                .setImage(image)
                .build()
        val tooLargeBitmap = getSampleBitmap(strokeWidth = 3, width = 1000, height = 1001)
        val otherImage =
            Image.newBuilder(TEST_COMPONENT_ID)
