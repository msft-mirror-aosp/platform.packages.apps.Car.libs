...
class HeaderTest {
    ...
    fun testGetTitle_nonNull() {
        val header = newBuilder(TEST_COMPONENT_ID).setTitle(TEST_HEADER).build()
    ...
    fun testGetTitle_null() {
        val header = newBuilder(TEST_COMPONENT_ID).setTitle(null).build()
    ...
    fun testGetLogo_null() {
        val header = newBuilder(TEST_COMPONENT_ID).build()
    ...
    fun testGetLogo_nonNull() {
        val header = newBuilder(TEST_COMPONENT_ID).setImage(image).build()
    ...
    fun testEquals_sameObject_returnTrue() {
        val header = newBuilder(TEST_COMPONENT_ID).setTitle(TEST_HEADER).setImage(image).build()
    ...
    fun testEquals_allFieldsEqual_returnTrue() {
        val header = newBuilder(TEST_COMPONENT_ID).setTitle(TEST_HEADER).setImage(image).build()
        val other = newBuilder(TEST_COMPONENT_ID).setTitle(TEST_HEADER).setImage(image).build()
    ...
    fun testEquals_differentComponentId_returnFalse() {
        val header = newBuilder(TEST_COMPONENT_ID).setTitle(TEST_HEADER).setImage(image).build()
        val other = newBuilder(TEST_HEADER).setTitle(TEST_HEADER).setImage(image).build()
    ...
    fun testEquals_differentTitle_returnFalse() {
        val header = newBuilder(TEST_COMPONENT_ID).setTitle(TEST_HEADER).setImage(image).build()
        val other =
            newBuilder(TEST_COMPONENT_ID).setTitle(TEST_COMPONENT_ID).setImage(image).build()
    ...
    fun testEquals_differentLogo_returnFalse() {
        ...
        val otherImage =
            Image.newBuilder(TEST_COMPONENT_ID)
                ...
                .build()
        val other =
            newBuilder(TEST_COMPONENT_ID).setImage(otherImage).setTitle(TEST_COMPONENT_ID).build()
    ...
    fun testToMessage() {
        val headerMessage =
            Header.HeaderMessage.newBuilder()
    ...
    fun testUpdateComponent_notEqualComponentId_returnFalse() {
        val header = newBuilder(TEST_COMPONENT_ID).setTitle(TEST_HEADER).setImage(image).build()
        val input = newBuilder(TEST_HEADER).setTitle(TEST_HEADER).setImage(image).build()
    ...
    fun testUpdateComponent_imageComponent_imageTooLarge_returnFalse() {
        val header = newBuilder(TEST_COMPONENT_ID).setTitle(TEST_HEADER).setImage(image).build()
        val tooLargeBitmap =
            BitmapUtility.getSampleBitmap(strokeWidth = 3, width = 1000, height = 1000)
        val otherImage =
            Image.newBuilder(TEST_COMPONENT_ID)
    ...
    fun testBuilder_setImage_incorrectContentScale_exceptionOccurred() {
        newBuilder(TEST_COMPONENT_ID)
            .setImage(
                Image.newBuilder(TEST_COMPONENT_ID).setContentScale(Image.ContentScale.FIT).build()
            )
            .build()
    }
