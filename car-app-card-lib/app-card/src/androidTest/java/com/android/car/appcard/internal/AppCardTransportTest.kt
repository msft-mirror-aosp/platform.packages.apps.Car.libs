...
class AppCardTransportTest {
  ...
  @Before
  fun setup() {
    imageMessage = ImageMessage.newBuilder()
      .setComponentId(TEST_COMPONENT_ID)
      .setImage(
        ByteString.copyFrom(
          BitmapUtility.convertToBytes(
            BitmapUtility.getSampleBitmap(strokeWidth = 3)
          )
        )
      )
      ...
      .build()
    buttonMessage = ButtonMessage.newBuilder()
      .setComponentId(TEST_COMPONENT_ID)
      .setImage(imageMessage)
      .setText(TEST_TITLE)
      .setType(ButtonType.PRIMARY)
      .build()
    headerMessage = HeaderMessage.newBuilder()
      .setComponentId(TEST_COMPONENT_ID)
      .setTitle(TEST_TITLE)
      .build()
    progressBarMessage = ProgressBarMessage.newBuilder()
      .setComponentId(TEST_COMPONENT_ID)
      .setMax(2)
      .setMin(0)
      .setProgress(1)
      .build()
    imageAppCardMessage = ImageAppCardMessage.newBuilder()
