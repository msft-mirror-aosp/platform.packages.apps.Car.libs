...
class ProgressBarTest {
    ...
    fun testBuilder_progressLessThanMin_throwError() {
        newBuilder(TEST_COMPONENT_ID, min = 1, max = 2).setProgress(0).build()
    }

    @Test(expected = IllegalStateException::class)
    fun testBuilder_maxLessThanProgress_throwError() {
        newBuilder(TEST_COMPONENT_ID, min = 0, max = 1).setProgress(2).build()
    }

    @Test
    fun testEquals_sameObject_returnTrue() {
        val progressBar = newBuilder(TEST_COMPONENT_ID, min = 1, max = 3).setProgress(2).build()
    ...
    fun testEquals_allFieldsEqual_returnTrue() {
        val progressBar = newBuilder(TEST_COMPONENT_ID, min = 1, max = 3).setProgress(2).build()
        val other = newBuilder(TEST_COMPONENT_ID, min = 1, max = 3).setProgress(2).build()
    ...
    fun testEquals_differentClass_returnFalse() {
        val progressBar = newBuilder(TEST_COMPONENT_ID, min = 1, max = 3).setProgress(2).build()
        val other = newBuilder(TEST_COMPONENT_ID).setTitle(TEST_OTHER_COMPONENT_ID).build()
    ...
    fun testEquals_differentComponentId_returnFalse() {
        val progressBar = newBuilder(TEST_COMPONENT_ID, min = 1, max = 3).setProgress(2).build()
        val other = newBuilder(TEST_OTHER_COMPONENT_ID, min = 1, max = 3).setProgress(2).build()
    ...
    fun testEquals_differentMin_returnFalse() {
        val progressBar = newBuilder(TEST_COMPONENT_ID, min = 1, max = 3).setProgress(2).build()
        val other = newBuilder(TEST_COMPONENT_ID, min = 0, max = 3).setProgress(2).build()
    ...
    fun testEquals_differentMax_returnFalse() {
        val progressBar = newBuilder(TEST_COMPONENT_ID, min = 1, max = 3).setProgress(2).build()
        val other = newBuilder(TEST_COMPONENT_ID, min = 1, max = 4).setProgress(2).build()
    ...
    fun testEquals_differentProgress_returnFalse() {
        val progressBar = newBuilder(TEST_COMPONENT_ID, min = 1, max = 3).setProgress(2).build()
        val other = newBuilder(TEST_COMPONENT_ID, min = 1, max = 3).setProgress(1).build()
    ...
    @Test
    fun testGetMin() {
        val progressBar = newBuilder(TEST_COMPONENT_ID, min = -1, max = 1).build()
    ...
    fun testGetProgress_setValue() {
        val progressBar = newBuilder(TEST_COMPONENT_ID, min = 0, max = 1).setProgress(1).build()
    ...
    fun testToMessage() {
        val progressBarMessage =
            ProgressBar.ProgressBarMessage.newBuilder()
                .setComponentId(TEST_COMPONENT_ID)
                .setMax(2)
                .setProgress(1)
                .setMin(0)
                .build()
        val progressBar = newBuilder(TEST_COMPONENT_ID, min = 0, max = 2).setProgress(1).build()
    ...
    fun testUpdateComponent_equalComponentId_correctUpdate() {
        val progressBar = newBuilder(TEST_COMPONENT_ID, min = 0, max = 1).build()
        val input = newBuilder(TEST_COMPONENT_ID, min = 1, max = 100).setProgress(10).build()
