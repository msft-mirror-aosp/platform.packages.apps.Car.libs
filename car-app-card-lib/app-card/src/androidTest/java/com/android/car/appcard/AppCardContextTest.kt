...
class AppCardContextTest {
    ...
    companion object {
        ...
        private fun checkBundleKeyAndValueEquality(first: Bundle, second: Bundle?): Boolean {
            ...
            val secondFastRefreshPeriod =
                second?.getInt(AppCardContext.BUNDLE_KEY_FAST_REFRESH_PERIOD)
            ...
            val firstImageAppCardMaxSize =
                firstImageContext?.getString(
                    AppCardContext.ImageAppCardContext.BUNDLE_KEY_IMAGE_SIZE_IMAGE_APP_CARD
                )
            val secondImageAppCardMaxSize =
                secondImageContext?.getString(
                    AppCardContext.ImageAppCardContext.BUNDLE_KEY_IMAGE_SIZE_IMAGE_APP_CARD
                )
            ...
            val firstButtonMaxSize =
                firstImageContext?.getString(
                    AppCardContext.ImageAppCardContext.BUNDLE_KEY_IMAGE_SIZE_BUTTON
                )
            val secondButtonMaxSize =
                secondImageContext?.getString(
                    AppCardContext.ImageAppCardContext.BUNDLE_KEY_IMAGE_SIZE_BUTTON
                )
            ...
            val firstHeaderMaxSize =
                firstImageContext?.getString(
                    AppCardContext.ImageAppCardContext.BUNDLE_KEY_IMAGE_SIZE_HEADER
                )
            val secondHeaderMaxSize =
                secondImageContext?.getString(
                    AppCardContext.ImageAppCardContext.BUNDLE_KEY_IMAGE_SIZE_HEADER
                )
            ...
            val firstMinButtons =
                firstImageContext?.getInt(
                    AppCardContext.ImageAppCardContext.BUNDLE_KEY_MIN_BUTTONS_IN_IMAGE_APP_CARD
                )
            val secondMinButtons =
                secondImageContext?.getInt(
                    AppCardContext.ImageAppCardContext.BUNDLE_KEY_MIN_BUTTONS_IN_IMAGE_APP_CARD
                )
