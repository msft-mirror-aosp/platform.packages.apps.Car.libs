...
class ProgressBar private constructor(builder: Builder) : Component(builder) {
    ...
    fun toMessage(): ProgressBarMessage =
    ...
    class Builder : Component.Builder {
        ...
        internal constructor(componentId: String, min: Int, max: Int) : super(componentId) {
            this.min = min
            this.max = max
            progress = min
        }
    ...
    companion object {
        ...
        @JvmStatic
        fun fromMessage(progressBarMessage: ProgressBarMessage) =
            Builder(progressBarMessage).build()
    }
}
