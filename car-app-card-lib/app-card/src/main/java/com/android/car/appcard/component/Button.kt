...
class Button private constructor(builder: Builder) : Component(builder) {
  ...
  fun toMessage(): ButtonMessage {
    ...
    text?.let {
      if (it.isNotEmpty()) builder.setText(it)
    }
    ...
    return builder
      ...
      .setType(toButtonType(buttonType))
      .build()
  }
  ...
  class Builder : Component.Builder {
    ...
    internal constructor(buttonMessage: ButtonMessage) : super(buttonMessage.componentId) {
      ...
      buttonType = when (buttonMessage.type) {
        com.android.car.appcard.internal.proto.Button.ButtonType.PRIMARY -> ButtonType.PRIMARY

        com.android.car.appcard.internal.proto.Button.ButtonType.SECONDARY -> ButtonType.SECONDARY

        com.android.car.appcard.internal.proto.Button.ButtonType.NO_BACKGROUND ->
          ButtonType.NO_BACKGROUND

        else -> throw IllegalStateException("ButtonType must not be unspecified nor unrecognized")
      }
    ...
    fun build(): Button {
      ...
      if (buttonType == ButtonType.NO_BACKGROUND) {
        val errMsg = "ButtonType.NO_BACKGROUND must contain an image with Image.ColorFilter.TINT"
        image?.let {
          check(it.colorFilter == Image.ColorFilter.TINT) { errMsg }
  ...
  companion object {
    ...
    private fun toButtonType(
      ...
      return when (buttonType) {
        ButtonType.SECONDARY -> com.android.car.appcard.internal.proto.Button.ButtonType.SECONDARY
     ...
     */
    @JvmStatic
    fun fromMessage(buttonMessage: ButtonMessage) = Builder(buttonMessage).build()
