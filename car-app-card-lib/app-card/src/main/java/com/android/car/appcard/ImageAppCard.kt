...
class ImageAppCard private constructor(builder: Builder) : AppCard(builder.id) {
  ...
  fun toMessage(): ImageAppCardMessage {
    ...
    header?.let {
      builder.setHeader(it.toMessage())
    }

    progressBar?.let {
      builder.setProgressBar(it.toMessage())
    }
    ...
    return builder
      .setAppCard(AppCardMessage.newBuilder().setId(id).build())
      .build()
  }

  override fun updateComponent(component: Component) {
    header?.let {
      if (it.updateComponent(component)) return
    }
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return super.equals(other) && image == other.image && buttons == other.buttons &&
    header == other.header && progressBar == other.progressBar &&
  ...
  class Builder {
    ...
    fun build(): ImageAppCard {
      ...
      image?.let {
        ...
        check(primaryText != null) {
          "Primary Text must be present when image is null"
        }
  ...
  companion object {
     ...
     */
    @JvmStatic
    fun newBuilder(id: String) = Builder(id)

    /**
     * @return an instance of [Builder] from an existing [ImageAppCard]
     */
    @JvmStatic
    fun newBuilder(imageAppCard: ImageAppCard) = Builder(imageAppCard)

    /**
     * @return an instance of [ImageAppCard] from [ImageAppCardMessage]
     */
    @JvmStatic
    fun fromMessage(imageAppCardMessage: ImageAppCardMessage) = Builder(imageAppCardMessage).build()
