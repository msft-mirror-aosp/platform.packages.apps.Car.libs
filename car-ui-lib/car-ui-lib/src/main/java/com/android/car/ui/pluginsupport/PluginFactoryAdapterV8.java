...
/**
 * This class is a wrapper around {@link PluginFactoryOEMV8} that implements {@link PluginFactory},
 * to provide a version-agnostic way of interfacing with the OEM's PluginFactory.
 */
public final class PluginFactoryAdapterV8 implements PluginFactory {
    @NonNull
    private final PluginFactoryOEMV8 mOem;
    @NonNull
    private final PluginFactoryStub mFactoryStub = new PluginFactoryStub();

    public PluginFactoryAdapterV8(@NonNull PluginFactoryOEMV8 oem) {
        mOem = oem;
    ...
    public RecyclerView.Adapter<? extends RecyclerView.ViewHolder> createListItemAdapter(
        ...
        List<ListItemOEMV1> oemItems = CarUiUtils.convertList(items,
                PluginFactoryAdapterV8::toOemListItem);
        ...
        adapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            ...
            public void onChanged() {
                oemItems.clear();
                oemItems.addAll(
                        CarUiUtils.convertList(items, PluginFactoryAdapterV8::toOemListItem));
