...
public final class ToolbarControllerAdapterV2 implements ToolbarController {
    ...
    public ToolbarControllerAdapterV2(
            @NonNull Context context,
            @NonNull ToolbarControllerOEMV2 oemToolbar) {
    ...
    private void update(ToolbarAdapterState newAdapterState) {
        ...
        if (newAdapterState.getSearchMode() != oldAdapterState.getSearchMode()) {
            switch (newAdapterState.getSearchMode()) {
                case SEARCH:
                    mOemToolbar.setSearchMode(ToolbarControllerOEMV2.SEARCH_MODE_SEARCH);
                    break;
                case EDIT:
                    mOemToolbar.setSearchMode(ToolbarControllerOEMV2.SEARCH_MODE_EDIT);
                    break;
                default:
                    mOemToolbar.setSearchMode(ToolbarControllerOEMV2.SEARCH_MODE_DISABLED);
            }
        }
        ...
        if (oldAdapterState.getNavButtonMode() != newAdapterState.getNavButtonMode()) {
            if (newAdapterState.getNavButtonMode() == NavButtonMode.DISABLED) {
                mOemToolbar.setNavButtonMode(ToolbarControllerOEMV2.NAV_BUTTON_MODE_DISABLED);
            } else if (newAdapterState.getNavButtonMode() == NavButtonMode.CLOSE) {
                mOemToolbar.setNavButtonMode(ToolbarControllerOEMV2.NAV_BUTTON_MODE_CLOSE);
            } else if (newAdapterState.getNavButtonMode() == NavButtonMode.DOWN) {
                mOemToolbar.setNavButtonMode(ToolbarControllerOEMV2.NAV_BUTTON_MODE_DOWN);
            } else {
                mOemToolbar.setNavButtonMode(ToolbarControllerOEMV2.NAV_BUTTON_MODE_BACK);
            }
        }
