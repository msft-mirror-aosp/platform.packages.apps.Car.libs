...
/**
 * This class is a wrapper around {@link PluginFactoryOEMV9} that implements {@link PluginFactory},
 * to provide a version-agnostic way of interfacing with the OEM's PluginFactory.
 */
public final class PluginFactoryAdapterV9 implements PluginFactory {
    @NonNull
    ...
    public AppStyledViewController createAppStyledView(@NonNull Context activityContext) {
        AppStyledViewControllerOEMV4 appStyledViewControllerOEMV4 = mOem.createAppStyledView(
                activityContext);
        return appStyledViewControllerOEMV4 == null ? new AppStyledViewControllerImpl(
                activityContext) : new AppStyledViewControllerAdapterV4(activityContext,
                appStyledViewControllerOEMV4);
    }
    ...
    public CarUiRecyclerView createRecyclerView(@NonNull Context context,
        ...
        RecyclerViewOEMV3 oemRecyclerView = mOem.createRecyclerView(context, oemAttrs);
    ...
    public RecyclerView.Adapter<? extends RecyclerView.ViewHolder> createListItemAdapter(
        ...
        List<ListItemOEMV1> oemItems = CarUiUtils.convertList(items,
                PluginFactoryAdapterV9::toOemListItem);

        AdapterOEMV2<? extends ViewHolderOEMV1> oemAdapter = mOem.createListItemAdapter(oemItems);
        ...
        RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter =
                new CarUiListItemAdapterAdapterV2(oemAdapter);
        adapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            @Override
            public void onChanged() {
                oemItems.clear();
                oemItems.addAll(
                        CarUiUtils.convertList(items, PluginFactoryAdapterV9::toOemListItem));
