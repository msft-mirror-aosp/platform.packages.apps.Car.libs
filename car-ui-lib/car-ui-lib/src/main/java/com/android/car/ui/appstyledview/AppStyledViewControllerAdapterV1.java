...
public class AppStyledViewControllerAdapterV1 implements AppStyledViewController {
    ...
    public AppStyledViewControllerAdapterV1(@NonNull Context context,
            @NonNull AppStyledViewControllerOEMV1 controllerOEMV1) {
    ...
    public void setSceneType(int sceneType) {
        // Do nothing. Scene type not supported in AppStyledViewControllerOEMV1.
    }
