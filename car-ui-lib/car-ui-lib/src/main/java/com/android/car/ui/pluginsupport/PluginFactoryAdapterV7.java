...
/**
 * This class is a wrapper around {@link PluginFactoryOEMV7} that implements {@link PluginFactory},
 * to provide a version-agnostic way of interfacing with the OEM's PluginFactory.
 */
public final class PluginFactoryAdapterV7 implements PluginFactory {
    @NonNull
    ...
    public RecyclerView.Adapter<? extends RecyclerView.ViewHolder> createListItemAdapter(
        ...
        List<ListItemOEMV1> oemItems = CarUiUtils.convertList(items,
                PluginFactoryAdapterV7::toOemListItem);
        ...
        adapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            ...
            public void onChanged() {
                oemItems.clear();
                oemItems.addAll(
                        CarUiUtils.convertList(items, PluginFactoryAdapterV7::toOemListItem));
            }
