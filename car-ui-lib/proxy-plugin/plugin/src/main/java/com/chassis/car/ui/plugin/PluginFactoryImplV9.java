...
import com.chassis.car.ui.plugin.appstyledview.AppStyledViewControllerAdapterProxyV4;
 ...
 */
public class PluginFactoryImplV9 implements PluginFactoryOEMV9 {
    private final PluginUiContextFactory mPluginUiContextFactory;

    public PluginFactoryImplV9(Context pluginContext) {
    ...
    @Nullable
    @Override
    public AppStyledViewControllerOEMV4 createAppStyledView(@NonNull Context sourceContext) {
        Context pluginContext = mPluginUiContextFactory.getPluginUiContext(sourceContext);
        ...
        AppStyledViewControllerImpl appStyledViewController = new AppStyledViewControllerImpl(
                pluginContext);
        return new AppStyledViewControllerAdapterProxyV4(appStyledViewController);
    }
