...
/**
 * Adapts a {@link CarUiListItemAdapter} into a {@link AdapterOEMV2}
 */
public class CarUiListItemAdapterAdapterProxyV2 implements
        AdapterOEMV2<CarUiListItemAdapterAdapterProxyV2.ViewHolderWrapper> {
    ...
    public void setStateRestorationPolicy(int policy) {
        switch (policy) {
            case AdapterOEMV2.PREVENT:
                mDelegateAdapter.setStateRestorationPolicy(StateRestorationPolicy.PREVENT);
                break;
            case AdapterOEMV2.PREVENT_WHEN_EMPTY:
                mDelegateAdapter.setStateRestorationPolicy(
                        StateRestorationPolicy.PREVENT_WHEN_EMPTY);
                break;
            case AdapterOEMV2.ALLOW:
            default:
                mDelegateAdapter.setStateRestorationPolicy(StateRestorationPolicy.ALLOW);
        }
    }
